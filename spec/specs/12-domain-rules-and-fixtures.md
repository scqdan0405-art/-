...
**C-1. 禁止物と補償対象外の区別（規約強化提案の仕分けを反映・2026-07-28）**
- **禁止物（＝そもそも預けられない・受入拒否）**：現金／パスポート・身分証／貴重品・宝石・ブランド品／危険物（火災系＝ガソリン・灯油・アルコール多量・花火・ガスボンベ・スプレー缶・大量のリチウム電池/モバイルバッテリー、化学薬物系＝化学物質・農薬・漂白剤・シンナー・ペンキ・毒物・医療廃棄物、生物食品系＝生物・動物・昆虫・生鮮/腐敗食品・植物）。予約画面のチェックボックス文面と禁止物ワークシートで確定。
- **補償対象外（＝預けられるが万一の補償対象にしない）**：PC・スマホ・電子機器／データ・HDD・SSD・USB等の記録媒体。規約に明記。
